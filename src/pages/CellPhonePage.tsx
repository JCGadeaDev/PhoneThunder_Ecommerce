      ...
      <div className="h-fit flex flex-col md:flex-row gap-16 mt-8">
        ...
        <div className="flex-1 space-y-5">
          ...
          <div className="flex flex-col gap-3">
            <p>{selectedColor && colors[selectedColor].name}</p>
          ...
          {isOutofStock ? (
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-8 px-5 py-3 border border-slate-200 w-fit">
                  <button>
                    <LuMinus size={15} />
                  </button>
          ...
          <div className="flex pt-2">
            ...
            <Link
              to="#"
              className="flex flex-col gap-1 flex-1 justify-center items-center"
            >
