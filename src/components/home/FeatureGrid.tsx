...
export const FeatureGrid = () => {
    return (
        <div className="grid grid-cols2 gap-8 mt-6 mb-16 lg:grid-cols-4 lg:gap-5">
            <div className="flex items-center gap-6">
                <MdLocalShipping size={40} className='text-slate-600' />

                <div className="space-y-1">
                    <p className="font-semibold">Envio Gratis</p>
                    <p className="text-sm">En todos nuestros prodcutos</p>
                </div>
            </div>
            <div className="flex items-center gap-6">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-sm">Devuelve el equipo si no satisface tu compra en 72 horas</p>
                </div>
            </div>
            <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-sm">Garantia de 1 año en todos los equipos</p>
                </div>
            </div>
        </div>
    )
